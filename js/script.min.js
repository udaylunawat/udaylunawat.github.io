(function ($) {
      ...
      handler: function (direction) {
        if (direction == "up") {
          ...
          $(".skillbar").each(function () {
            $(this)
              .find(".skillbar-bar")
              .animate({ width: jQuery(this).attr("data-percent") }, 2000);
          });
        }
      },
    ...
    if (navigator.userAgent.indexOf("Opera Mini") != -1) {
      ...
      $(".skillbar").each(function () {
        $(this)
          .find(".skillbar-bar")
          .animate({ width: jQuery(this).attr("data-percent") }, 0);
      });
      $("input").removeClass("form-control");
      $("input").css({ width: "100%", height: "50px", background: "#fff" });
      $(".navigation-icon").css("display", "none");
    }
    if (navigator.userAgent.indexOf("UCBrowser") != -1) {
      $(".navigation-icon").css("display", "none");
      $(".fun-facts").css({ display: "table", margin: "auto" });
      work.start();
      happyClient.start();
      projects.start();
      coffee.start();
    ...
    var wow = new WOW({ animateClass: "animated", offset: 70, mobile: false });
    wow.init();
